...
function product (){
    this.route.post('/product',auth, checkRole(['super-admin', 'admin']),addProduct(this));
    ...
    this.route.delete('/product/:_id',auth, checkRole(['super-admin', 'admin']), removeProduct(this));
